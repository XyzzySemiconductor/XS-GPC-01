	...
	logic signed [37:0] vcap, next_vcap; // 340 V / 1744 DN
	logic signed [15:0] pdump; // 340 W / 1744 DN
   ...
   // responds and provides Vac and Vdc readings and a phase angle contrl
	...
	initial begin
		for( int ii = 0; ii < 63; ii++ ) begin
			dtocv_rom[ii] = ( 67108864.0 * 1744.0 / ( C * F * (ii * 32.0 + 16) * 340.0 ));
	...
	always @(negedge clk) begin
		if( reset ) begin
			...
			pdump = ( !pwm ) ? 0 : ((vcap[36-:11] * vcap[36-:11] ) >> 6) ; // 340/1744/12.8 ~= 1/64 for R = 12.8 ohms. 
